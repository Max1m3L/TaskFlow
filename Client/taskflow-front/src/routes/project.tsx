        ...
        <Layout>
            <div className="flex items-start gap-x-5 p-7">
                <section className="flex-grow bg-[#fff] rounded-[32px] border-2 border-[#C9C6C3] p-10">
                    <span className="font-light text-[#595858] text-lg">#{project?.id}</span>
                    <h1 className="font-bold text-3xl">{project?.name}</h1>
                    <span className="block text-2xl pt-3 pb-6">Сроки: с {project?.startDate} до {project?.endDate}</span>
